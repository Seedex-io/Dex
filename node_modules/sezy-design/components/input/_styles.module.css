...
.sezy-input-wrapper {
  & {
    ...
    position: relative;
    box-sizing: border-box;
    transition: box-shadow 0.38s, border 0.38s;
    border-radius: var(--border-radius);
...
.sezy-input- {
  ...
  &l {
    ...
    & > .sezy-input {
      /* height:4rem; */
      line-height:4rem;
      /* padding: 0.625rem 1.1rem 0.625rem 0; */
...
.sezy-input-{
  &outline{
    ...
    &:focus-within {
      ...
      box-shadow: 0px 0px 2px 1px var(--border-shadow-active-color);
      z-index: 1;
    }
  }
  &flat{
