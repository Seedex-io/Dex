...
export default function LeftNavbar({ onToggle }: LeftNavbarProps) {
  ...
  return (
    <div
      ...
      <AutocompleteInput className='hover:border-red-400' />
